...
var applyView_fn = ['$scope', '$stateParams', '$modal', '$rootScope', 'restAPI', 'Notification', '$state',
  function ($scope, $stateParams, $modal, $rootScope, restAPI, Notification, $state) {
    ...
    function getSaveData() {
      var data = [];
      angular.forEach(vm.billObj.auditData, function (v, k) {
...
module.exports = angular.module('app.pactlReceive.applyView', []).controller('applyViewCtrl', applyView_fn);